...
class Image
{
  ...
  protected:
	...
	int		forewardStart;	//first frame of foreward animation
	int		forewardEnd;		//last frame of foreward animation
	int		backwardStart;	//first frame of backward animation
	int		backwardEnd;	//last frame of backward animation
	int		leftStart;		//first frame of left animation
	int		leftEnd;		//last frame of left animation
	int		stillFrame;		//standing still
