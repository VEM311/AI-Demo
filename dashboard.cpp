...
//=============================================================================
bool Bar::initialize(Graphics *graphics, TextureManager *textureM, int middle,
                     int bottom, float scale, COLOR_ARGB color)
{
    try {
        ...
        spriteData.x = (float)middle;
        spriteData.y = (float)bottom;
